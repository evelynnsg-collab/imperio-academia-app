...
{id:"db_reverse_band_sumo_deadlift",nome:"Terra Sumô com Elástico Reverso",nome_en:"",grupo:"Posterior de Coxa",principais:["Isquiotibiais"],secundarios:["Abdutores", "Adutores"],equipamento:"Barra",nivel:"Avançado",passos:["Begin with a bar loaded on the floor inside of a power rack. Attach bands to the top of the rack, using either pegs or the frame itself. Attach the other end to the barbell.", "Approach the bar so that the bar intersects the middle of the feet. The feet should be set very wide, near the collars. Bend at the hips to grip the bar. The arms should be directly below the shoulders, inside the legs, and you can use a pronated grip, a mixed grip, or hook grip. Relax the shoulders, which in effect lengthens your arms.", "Take a breath, and then lower your hips, looking forward with your head with your chest up. Drive through the floor, spreading your feet apart, with your weight on the back half of your feet. Extend through the hips and knees."],erros:[],cuidados:[],series:"4-5",reps:"10-12",descanso:"75s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Reverse_Band_Sumo_Deadlift/0.jpg"},
{id:"db_split_snatch",nome:"Snatch Dividido",nome_en:"",grupo:"Posterior de Coxa",principais:["Isquiotibiais"],secundarios:["Panturrilha", "Antebraço"],equipamento:"Barra",nivel:"Avançado",passos:["Begin with a loaded barbell on the floor. The bar should be close to or touching the shins, and a wide grip should be taken on the bar. The feet should be directly below the hips, with the feet turned out as needed. Lower the hips, with the chest up and the head looking forward. The shoulders should be just in front of the bar. This will be the starting position.", "Begin the first pull by driving through the front of the heels, raising the bar from the ground. The back angle should stay the same until the bar passes the knees.", "Transition into the second pull by extending through the hips knees and ankles, driving the bar up as quickly as possible. The bar should be close to the body. At peak extension, shrug the shoulders and allow the elbows to flex to the side."],erros:[],cuidados:[],series:"4-5",reps:"10-12",descanso:"75s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Split_Snatch/0.jpg"},
...
{id:"db_stiff_leg_barbell_good_morning",nome:"Good Morning com Barra Pernas Retas",nome_en:"",grupo:"Costas",principais:["Eretores"],secundarios:["Glúteos", "Isquiotibiais"],equipamento:"Barra",nivel:"Iniciante",passos:["This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.", "Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.", "Step away from the rack and position your legs using a shoulder width medium stance. Keep your head up at all times as looking down will get you off balance and also maintain a straight back. This will be your starting position."],erros:[],cuidados:[],series:"3",reps:"8-12",descanso:"90s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Stiff_Leg_Barbell_Good_Morning/0.jpg"},
...
{id:"db_clean_shrug",nome:"Encolhimento do Clean",nome_en:"",grupo:"Costas",principais:["Trapézio"],secundarios:["Antebraço", "Deltóide"],equipamento:"Barra",nivel:"Iniciante",passos:["Begin with a shoulder width, double overhand or hook grip, with the bar hanging at the mid thigh position. Your back should be straight and inclined slightly forward.", "Shrug your shoulders towards your ears. While this exercise can usually by loaded with heavier weight than a clean, avoid overloading to the point that the execution slows down."],erros:[],cuidados:[],series:"3",reps:"8-12",descanso:"90s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Clean_Shrug/0.jpg"},
...
{id:"db_hip_extension_with_bands",nome:"Extensão de Quadril com Elástico",nome_en:"",grupo:"Glúteos",principais:["Glúteos"],secundarios:["Isquiotibiais"],equipamento:"Elástico",nivel:"Iniciante",passos:["Secure one end of the band to the lower portion of a post and attach the other to one ankle.", "Facing the attachment point of the band, hold on to the column to stabilize yourself.", "Keeping your head and your chest up, move the resisted leg back as far as you can while keeping the knee straight."],erros:[],cuidados:[],series:"3",reps:"12-15",descanso:"75s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Extension_with_Bands/0.jpg"},
{id:"db_hip_lift_with_band",nome:"Elevação de Quadril com Elástico",nome_en:"",grupo:"Glúteos",principais:["Glúteos"],secundarios:["Panturrilha", "Isquiotibiais"],equipamento:"Elástico",nivel:"Iniciante",passos:["After choosing a suitable band, lay down in the middle of the rack, after securing the band on either side of you. If your rack doesn't have pegs, the band can be secured using heavy dumbbells or similar objects, just ensure they won't move.", "Adjust your position so that the band is directly over your hips. Bend your knees and place your feet flat on the floor. Your hands can be on the floor or holding the band in position.", "Keeping your shoulders on the ground, drive through your heels to raise your hips, pushing into the band as high as you can."],erros:[],cuidados:[],series:"3",reps:"12-15",descanso:"75s",video:"",img_url:"https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hip_Lift_with_Band/0.jpg"},
